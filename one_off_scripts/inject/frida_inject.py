...
helloFN = getattr(script.exports_sync, 'hello')
hellResult = helloFN()
print(f"helloFN result: {hellResult}")

copyFN = getattr(script.exports_sync, 'copy')
copyResult = copyFN("This is a test message.")
print(f"copyFN result: {copyResult}")
